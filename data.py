...
def prepare_data(args):
    ...
    train_data_pool = train_data_all[:, :]
    train_target_pool = train_target_all[:]
    ...
    for i in range(0, 2):
        ...
        data_i = train_data_all.numpy()[idx[0][0:args.pre_size], :]
        target_i = train_target_all.numpy()[idx[0][0:args.pre_size]]
    ...
    # 创建dataloader
    train_dataloader = DataLoader(my_dataset, batch_size=args.batch_size, shuffle=True)
